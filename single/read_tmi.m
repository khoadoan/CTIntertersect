function [latitude, longitude, time] = read_tmi( dir_tmi, name_tmi, current_day, current_year)
    ...
    latitude = hdfread(file_tmi, '/Swath/Latitude');
    longitude = hdfread(file_tmi, '/Swath/Longitude');
