function [ output_args ] = write_all_output( intersections, output_dir )
    ...
    for iIndex = 1:noOfIntersections
        ...
        write_sds(AMSRE_Context_Time, 'AMSR E Time', 'double', cs_trmm_hdf_id);
        ...
        %% WRITE TMI CONTENT 
        write_sds(single(TMI_1B11_Latitude(TMI_Context_Range, :)), 'TMI Curtain Latitude', 'float', cs_trmm_hdf_id);
        write_sds(single(TMI_1B11_Latitude(TMI_Context_Range, :)), 'TMI Curtain Longitude', 'float', cs_trmm_hdf_id);
        write_sds(single(TMI_Context_Time), 'TMI Curtain Time', 'float', cs_trmm_hdf_id);
