...
================================
-cloudsat 
-run_cloudsat.sh (shell script run to temporarily set environment variables and execute 
                  the application)
   -to run the shell script, type
   
       ./run_cloudsat.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/R2010a/v713, run the shell script as:
       ...
       ./run_cloudsat.sh /mathworks/home/application/R2010a/v713
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_cloudsat.sh /mathworks/devel/application/matlab
-MCRInstaller.bin
    ...
    Linux                   LD_LIBRARY_PATH
     ...
     ii. Set the path by doing one of the following:
        ...
        NOTE: When deploying standalone applications, it is possible 
              to run the shell script file run_cloudsat.sh 
